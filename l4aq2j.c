//this code is a tokenizer meant for javascript, tread carefully my liege
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
const char *keywords[] = {
    ...
    "switch", "case", "break", "continue", "default", "new", "try", "catch",
    "throw", "typeof", "class", "extends", "import", "export", "async", "await"
};
...
// Function to check if a token is a JavaScript keyword
